...
class App : Application() {
	override fun onCreate() {
		super.onCreate() // FIXME: should settings be loaded here and available through Context?
		startKoin {
			androidContext(this@App)
			modules(coreModule, settingsModule, chapterModule, wordModule, pictureModule)
		}
	}
}