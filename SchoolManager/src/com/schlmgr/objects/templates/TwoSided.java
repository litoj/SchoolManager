 ...
 * cares about its parent. Defines the system for objects used in a {@link com.schlmgr.testing.Test}.
...
public abstract class TwoSided<T extends TwoSided> extends Element implements Container {
	...
	protected TwoSided(com.schlmgr.IOSystem.Formatter.Data bd, boolean isMain, Map<com.schlmgr.objects.MainChapter, List<T>> NET) {
		super(bd);
		this.isMain = isMain;
