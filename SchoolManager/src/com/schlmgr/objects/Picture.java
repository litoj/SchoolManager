...
import static com.schlmgr.testing.NameReader.readName;
...
public class Picture extends TwoSided<Picture> {
	 ...
	 * @return new
	 * {@linkplain #Picture(com.schlmgr.IOSystem.Formatter.Data, java.util.List, boolean) Picture object}
	 ...
	 * @return new
	 * {@linkplain #Picture(Data, java.util.List, boolean) Picture object}
	...
	private Picture(Data bd, List<Data> images, boolean isNew) {
		...
		createDir(new File(identifier.getDir(), "Pictures"));
	...
	public static BasicData readData(com.schlmgr.IOSystem.ReadElement.Source src, Container parent) {
		Data data = com.schlmgr.IOSystem.ReadElement.get(src, true, true, true, true, parent);
		List<Data> children = com.schlmgr.IOSystem.ReadElement.readChildren(src, true, true, true, parent);
